...
class TermsConstants {
  static const content = [
    Term(
        description:
            'Games built the TimerApp app as a Free app. This SERVICE is provided by Games at no cost and is intended for use as is.'),
    Term(
        description:
    ...
    Term(
        description:
            'The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at TimerApp unless otherwise defined in this Privacy Policy.'),
    Term(
